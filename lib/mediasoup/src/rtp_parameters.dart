...
enum RtpHeaderDirection { SendRecv, SendOnly, RecvOnly, Inactive }
  ...
  static RtpEncodingParameters fromMap(Map data) {
    return RtpEncodingParameters(
      ...
      priority: data['priority'] != null
          ? RTCPriorityTypeExtension.fromString(data['priority'])
          : RTCPriorityType.low,
      networkPriority: data['networkPriority'] != null
          ? RTCPriorityTypeExtension.fromString(data['networkPriority'])
          : null,
  ...
  Map<String, dynamic> toMap() {
    return {
      ...
      if (networkPriority != null)
        'networkPriority': networkPriority?.priorityValue,
    };
  }
...
class RtcpParameters extends RTCRTCPParameters {
  ...
  @override
  Map<String, dynamic> toMap() {
    return {'cname': cname, 'reducedSize': reducedSize, 'mux': mux};
  }
}
